...
install_resource "Chivy/Core/Resources/CHFindOnPageActivity@2x.png"
install_resource "Chivy/Core/Resources/CHFindOnPageActivity@2x~ipad.png"
install_resource "Chivy/Core/Resources/CHSearchWebView.js"
